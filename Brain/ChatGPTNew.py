...
FileLoginGoogle = open("Brain\\Google.txt", "r")
DataGoogle = FileLoginGoogle.read()
FileLoginGoogle.close()
GoogleEmail, GooglePassword = str(DataGoogle).split(",")
IdorEmail = GoogleEmail
